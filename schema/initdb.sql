...
-- Create default user "training" with no password
INSERT INTO guacamole_entity (name, type) VALUES ('training', 'USER');
INSERT INTO guacamole_user (entity_id, password_hash, password_salt, password_date)
SELECT
    entity_id,
    decode('DEADBEEF', 'hex'), 
    decode('DEADBEEF', 'hex'),
    CURRENT_TIMESTAMP
FROM guacamole_entity WHERE name = 'training' AND guacamole_entity.type = 'USER';
...
INSERT INTO guacamole_connection_parameter (connection_id, parameter_name, parameter_value)
SELECT connection_id, 'username', 'ubuntu' FROM guacamole_connection;

INSERT INTO guacamole_connection_permission (entity_id, connection_id, permission)
SELECT guacamole_entity.entity_id, connection_id, 'READ'
FROM guacamole_entity 
CROSS JOIN guacamole_connection
WHERE guacamole_entity.name = 'training' AND guacamole_entity.type = 'USER';
